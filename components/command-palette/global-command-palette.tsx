...
const STATIC_GROUPS: { group: string; items: CmdItem[] }[] = [
  {
    ...
    items: [
      ...
      { id: "carrier-journal", label: "Field Journal", href: "/carrier-journal", icon: BookOpen, meta: "walking fitness log" },
      { id: "field-log", label: "Field Log", href: "/carrier-journal", icon: BookOpen, meta: "walking fitness log" },
