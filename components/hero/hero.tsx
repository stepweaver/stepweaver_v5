    ...
    <section className="relative min-h-screen flex items-center">
      <div className="w-full max-w-[1920px] mx-auto px-3 sm:px-5 md:px-6 lg:px-10 xl:px-14 2xl:px-16 pt-20 pb-12">
        <div className="flex flex-col lg:grid lg:grid-cols-[minmax(260px,380px)_minmax(0,1fr)] xl:grid-cols-[minmax(300px,440px)_minmax(0,1.35fr)] gap-8 lg:gap-10 xl:gap-16 2xl:gap-24 lg:items-stretch">
          <div className="order-1 lg:order-2 lg:col-start-2 flex flex-col min-h-0 min-w-0 lg:pl-4 xl:pl-10 2xl:pl-14 lg:border-l border-[rgb(var(--border)/0.12)] lg:pt-1">
            <HeroHeadline />
            <HeroDescription />
          </div>
          <div className="order-2 lg:order-1 lg:col-start-1 lg:row-span-2 lg:pt-4 xl:pt-8 lg:flex lg:flex-col">
            <HeroOperatorCard />
          </div>
          <div className="order-3 lg:order-2 lg:col-start-2 flex flex-col min-h-0 min-w-0 lg:pl-4 xl:pl-10 2xl:pl-14">
