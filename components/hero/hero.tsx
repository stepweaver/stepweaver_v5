...
export function Hero() {
  return (
    <section className="relative min-h-[min(100vh,56rem)] flex items-center">
      <div className="w-full max-w-[1920px] mx-auto px-3 sm:px-5 md:px-6 lg:px-10 xl:px-14 2xl:px-16 pt-20 pb-12">
        <div className="flex flex-col lg:grid lg:grid-cols-[minmax(260px,380px)_minmax(0,1fr)] xl:grid-cols-[minmax(300px,440px)_minmax(0,1.35fr)] gap-8 lg:gap-10 xl:gap-16 2xl:gap-24 lg:items-stretch">
          {/* max-lg:contents lets headline + bio interleave with card in one column; lg groups them in the right column */}
          ...
          <div className="order-2 lg:order-none lg:col-start-1 lg:row-start-1 lg:pt-4 xl:pt-8 lg:flex lg:flex-col">
            <HeroOperatorCard />
          </div>
        </div>
      </div>
