  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Qualification badge system: mileage ranks, field events, weather days, hydration consistency, and load milestones computed from dispatch data",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Badge logic is aggregate-first: achievements are computed from repeatable field signals instead of manually awarded one-off trophies",
      ],
    },
    {
      id: "tradeoffs",
      ...
      bullets: [
        ...
        "Miles replace steps as the primary movement signal: cleaner route comparison, less consumer-fitness noise",
