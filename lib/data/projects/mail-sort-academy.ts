  ...
  sections: [
    {
      ...
      type: "overview",
      content:
        "Mail Sort Academy is an unofficial letter carrier study game built from the inside out. I became a city letter carrier and immediately noticed that learning the actual sorting rules — UBBM decisions, carrier endorsements, accountable mail chain — requires a kind of rapid pattern recognition that reading a handbook alone does not build. So I built a scored, keyboard-driven drill tool that puts real postal scenarios in front of you and makes you decide under time pressure. It is not a USPS product. It is a study tool written by someone who does the job.",
    },
    {
      id: "problem",
      title: "The Problem",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Scenario-based mail cards with shape, class, mailer endorsement, and extra service all encoded — same complexity as real mail",
    ...
    },
    {
      ...
      type: "architecture",
      content:
        "Every answer is scored against the card's known-correct answer. Correct answers earn 100 points. Answers under 7 seconds earn a 25-point speed bonus on top of that. Wrong answers cost 50 points. Critical mistakes — illegal UBBM rulings on First-Class, Priority, accountable, or return-service mail; applying DEC to mail that is not actually a deceased case — cost 100 points and are tracked separately from ordinary wrong answers. Lifetime stats persist in localStorage: lifetime score, best round score, rounds completed, cards answered, and total critical errors.",
    },
    {
    ...
    },
    {
      ...
      bullets: [
        ...
        "buildRoundDeck filters and shuffles the mail card catalog per mode, then slices to 10 cards — same API regardless of mode",
